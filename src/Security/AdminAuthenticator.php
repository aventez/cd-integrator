...
class AdminAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    {
        return 'integrator_login' === $request->attributes->get('_route')
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        return new RedirectResponse($this->urlGenerator->generate('integrator_dashboard'));
    }

    protected function getLoginUrl()
    {
        return $this->urlGenerator->generate('integrator_login');
    }
}
